<template>
	<view class="register">
		...
		<view class="content">
			...
			<!-- 主体 -->
			<view class="main">
				<wInput v-model="username" type="text" maxlength="30" placeholder="昵称"></wInput>
				<wInput v-model="email" type="text" maxlength="30" placeholder="注册邮箱"></wInput>
				<wInput v-model="password" type="password" maxlength="30" placeholder="登录密码" isShowPass></wInput>
	...
	export default {
		...
		methods: {
			...
			getVerCode() {
				...
				this.$refs.runCode.$emit('runCode', 60);
				sendEmailVerificationCode(httpData).then((res) => {
