...
<!-- #ifdef APP-PLUS || MP-WEIXIN || H5 || MP-QQ -->
<script lang="wxs" module="QSTABSWXS" src="@/components/QS-tabs-wxs-list/wxs/QS-tabs-wxs.wxs"></script>
<script lang="wxs" module="QSREFRESHWXS" src="@/components/QS-tabs-wxs-list/wxs/QS-refresh-wxs.wxs"></script>
<!-- #endif -->
